...
}console.log(tienenMismaLongitud("hola", "holaj"))
...
console.log(menosQueNoventa(300))
...
console.log(obtenerResto(5.5 , 2))
...
console.log(areaDelTriangulo(7,7))
